...
public class MessageController {
    ...
    public Object sendMessageToChat(HttpServletRequest request, @Valid @RequestBody MessageBody messageBody){
        ...
        messagingTemplate.convertAndSendToUser(userEntity.getUuid(), "/events", new MessageSend(messageEntity.getChatId(), messageEntity.getText(), messageEntity.getSendDate()));
        messagingTemplate.convertAndSendToUser(recipientEntity.getUuid(), "/events", new MessageNew(messageEntity.getChatId(), messageEntity.getText(), messageEntity.getSendDate()));
